...
public sealed class DialogTests
{
    ...
    public void TestNavigation()
    {
        ...
        {
            [page1] = clickedControl => clickedControl == Button.Cancel ? null : page2,
            [page2] = clickedControl => clickedControl == Button.Cancel ? null : page3,
            [page3] = clickedControl => clickedControl == Button.Cancel ? null : page1,
        });
